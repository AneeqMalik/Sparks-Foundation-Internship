...
mongoose.connect("mongodb+srv://AneeqMalik:aneeq@cluster0.aijfz.mongodb.net/banksystem?retryWrites=true&w=majority", {
...
const defaultUserNames = ["Aneeq Malik", "Ayan", "Zanaib", "Masood","Sabhi", "Hassan", "Jamal", "Alina", "Marya", "Owais"];
const defaultUsersEmail = ["aneeqmalik@gmail.com", "ayan@gmail.com", "zanaib@gmail.com", "masood@gmail.com", "sabhi@gmail.com", "hassan@gmail.com", "Alina@gmail.com", "marya@gmail.com", "bilal@gmail.com", "owais@gmail.com"];
const defaultUsersAddress = ["Karahi", "Gilgit", "Lahore", "Mussafarabad", "Hyderabad", "Karachi", "Mirpurkhas", "Sukkur", "Larkana","Peshawar"];

const defaultUsers = [];
for (let i = 0; i < defaultUserNames.length; i++) {
    if (defaultUserNames[i] === "Zaniab" || defaultUserNames[i] === "Marya" || defaultUserNames[i] === "Alina") {
...
app.listen(port, function () {
    console.log("srever has started successfully");
});